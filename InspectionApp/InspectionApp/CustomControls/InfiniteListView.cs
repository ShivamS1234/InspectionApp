...
namespace InspectionApp
{
  public class InfiniteListView : ListView
  {
    ...
    public static readonly BindableProperty IsScrollBarShowAlwaysProperty =
        BindableProperty.Create<InfiniteListView, bool>(
            p => p.IsScrollBarShowAlways, false, BindingMode.TwoWay, null);
    ...
    public bool IsScrollBarShowAlways
    {
      get { return (bool)this.GetValue(IsScrollBarShowAlwaysProperty); }
      set { this.SetValue(IsScrollBarShowAlwaysProperty, value); }
    }
